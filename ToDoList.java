...
public class ToDoList {
	...
	public void writeFile(String text, DefaultListModel l)
	{
		FileWriter fw = new FileWriter(text, l);
	}
	/**
	...
	private void initialize() {
		...
		btnExport.addActionListener(event -> writeFile(lblDay.getText() ,listModel));
